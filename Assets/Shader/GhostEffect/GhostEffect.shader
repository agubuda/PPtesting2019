Shader "LwyShaders/longEffectTransparent"
{
     Properties
    {
        ...
        _FresnelStepWidth ("_FresnelStepWidth", Range(0, 1)) = 0.2
    ...
    SubShader
    {
        ...
        pass
        {
            ...
            CBUFFER_START(UnityPerMaterial)
                ...
                float _FresnelStepValue , _FresnelStepWidth;
                float4 _BaseColor;
            ...
            float4 frag(v2f input) : SV_TARGET
            {
                ...
                float4 finalFresnelRim = smoothstep(_FresnelStepValue,_FresnelStepValue + _FresnelStepWidth,fresnelRim);
                ...
                float4 color = (halfLambert * difusse  * _BaseColor  + finalFresnelRim) ;
