...
/// <summary>
    /// 自定义RenderPass
    /// </summary>
    public class CopyShaderPass : ScriptableRenderPass
    {
        //for debugger
        ...
        private UnityEngine.Experimental.Rendering.Universal.RenderQueueType m_renderQueueType;
        ...
        public OutlineRenderPass(string profilerTag ,RenderPassEvent renderPassEvent,FilterSettings filterSettings)
        {
            ...
            RenderQueueRange renderQueueRange = (filterSettings.renderQueueType == UnityEngine.Experimental.Rendering.Universal.RenderQueueType.Transparent)
        ...
        {
            SortingCriteria sortingCriteria = (m_renderQueueType == UnityEngine.Experimental.Rendering.Universal.RenderQueueType.Transparent)
